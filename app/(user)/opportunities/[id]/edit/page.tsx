...
import { GetAll as GetAllProject } from "@/actions/project";
...
const Page: React.FC = () => {
  ...
  const { handleSubmit, control, setValue } = useForm({
    ...
    defaultValues: {
      information: "",
      opportunity: "66e2b309a7ce690f454a4ac5",
    },
  });
  ...
  useEffect(() => {
    GetAll().then(async (data) => {
      ...
      setOptions(aa);
      let projects = await GetAllProject({ _id: id });
          ...
          <div className="flex flex-row justify-between">
            ...
            <div className="flex-[5] ">
              <Controller
                name="opportunity"
                rules={{ required: true }}
                defaultValue={project.opportunity?._id}
                control={control}
                render={({
                  ...
                  return (
                    <>
                      <ReactSelect
                        defaultValue={"66e2b309a7ce690f454a4ac5"}
                        options={options}
                        onChange={(e: any) => {
